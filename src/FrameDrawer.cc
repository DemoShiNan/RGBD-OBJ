...
void FrameDrawer::Update(Tracking *pTracker)
{
    ...
    // cout<<"before  widgets clear :"<<detections_widgets_.size() <<endl;
    detections_widgets_.clear();
    // cout<<"after  widgets clear :"<<detections_widgets_.size() <<endl;
    const auto& detections = pTracker->GetCurrentFrameDetections();
    // cout<<"get new current widgets :"<<detections.size() <<endl;
    ...
    // cout<<"after  widgets adding :"<<detections_widgets_.size() <<endl;
